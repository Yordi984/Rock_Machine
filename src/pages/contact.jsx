      ...
      <main className="py-24 px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 p-[2px] bg-gradient-to-br from-yellow-500 to-yellow-600 rounded-[3rem]">
              <div className="bg-[#0f0f0f] h-full w-full rounded-[2.9rem] p-12 flex flex-col justify-between">
                <div>
                ...
                <div className="mt-12 flex flex-col sm:flex-row gap-8 items-center md:items-start">
                  <a
                    href="https://wa.me/529984187535"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="btn rounded-full px-10 h-16 border-none bg-yellow-500 hover:bg-yellow-400 hover:text-black transition-all duration-300 w-full sm:w-auto flex items-center justify-center"
                  >
                    <span className="font-black tracking-[0.2em] text-[10px] uppercase text-black">
                      Abrir WhatsApp
                    </span>
                  </a>
            ...
            <div className="flex flex-col gap-6">
              {/* Ubicación */}
              <div className="bg-neutral-900/40 border border-white/5 p-8 rounded-[2.5rem] flex items-start gap-4">
                <svg
              ...
              <div className="bg-neutral-900/40 border border-white/5 p-8 rounded-[2.5rem]">
                <h4 className="font-black uppercase tracking-[0.2em] text-[10px] text-yellow-500 mb-6">
                  Síguenos
                </h4>
              ...
              <div className="bg-neutral-900/40 border border-white/5 p-8 rounded-[2.5rem] flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-gray-300 tracking-tighter">
